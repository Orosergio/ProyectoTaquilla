        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string tabla = "INSERT INTO EMPLEADO (idEmpleado,nombre,apellido,idPuesto,fechaContratacion,fechaNacimiento,estatus) VALUES (" + codigoA.ToString() + "," + txtNombre.Text.ToString() + "," + txtApellido.Text.ToString() + "," + cboCodigoPuesto.SelectedItem.ToString() + "," + fechaContratacion.ToString() + "," + fechaNacimiento.ToString() + "," + uno.ToString() + ")";
