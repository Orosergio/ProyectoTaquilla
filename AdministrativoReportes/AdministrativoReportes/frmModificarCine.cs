...
namespace AdministrativoReportes
{
    public partial class frmModificarCine : Form
    {
        ...
        void procCargarCine()
        {
            try
            {
                ...
                while (mostrarC.Read())
                {
                    ...
                    duwTiempo.Text = mostrarC.GetString(4);
       ...
       void procLimpiar()
        ...
        {
            if (cboEstatus.SelectedItem == null || cboDepartamento.SelectedItem == null || cboMunicipio.SelectedItem == null || cboCine.SelectedItem == null || txtCine.Text == "" || txtDireccion.Text == "" || duwTiempo.Text == "")
            {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string Modificar = "UPDATE Cine SET  nombre = '" + txtCine.Text + "' ,idMunicipio = " + Int32.Parse(cboCodigoM.SelectedItem.ToString()) + " ,Direccion = '" + txtDireccion.Text + "',tiempoCompra = " + Int32.Parse(duwTiempo.Text.ToString()) + ",estatus = '" + Estatus + "'  WHERE idCine= " + Int32.Parse(cboCodigoCine.SelectedItem.ToString());
                ...
                string proceso = "Modificación de Cine";
                string tabla = "UPDATE Cine SET  nombre = " + txtCine.Text.ToString() + " ,idMunicipio = " + cboCodigoM.SelectedItem.ToString() + ",Direccion = " + txtDireccion.Text.ToString() + ",tiempoCompra = " + duwTiempo.Text.ToString() + ",estatus = " + Estatus.ToString() + " WHERE idCine= " + cboCodigoCine.SelectedItem.ToString()+"";
        ...
        {
            Help.ShowHelp(this, "AyudaAgregado/AyudaAgregado.chm", "ModificacionCines.html");
        }

        private void frmModificarCine_Load(object sender, EventArgs e)
        {
