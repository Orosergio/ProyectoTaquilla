...
namespace AdministrativoReportes
{
    public partial class frmPromocion : Form
    {
        ...
        {
            Help.ShowHelp(this, "AyudaAgregado/AyudaAgregado.chm", "IngresoDescuentos.html");
        }
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string proceso = "Adición de promociones";
                string tabla = "INSERT INTO PROMOCION (idPromocion,NombrePromocion,CantidadDescuento,fechaInicio,fechaFinal,idBoleto,estatus) VALUES (" + codigoA.ToString() + "," + txtPromocion.Text.ToString() + "," + txtDescuento.Text.ToString() + "," + fechaI.ToString() + "," + fechaF.ToString() + "," + lblCodigoBoleto.Text.ToString() + "," + Estatus.ToString() + ")";
