        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string tabla = "UPDATE PROYECCIONPELICULA SET idPelicula = " +cboCodigoPN.SelectedItem.ToString() + ", idSala = " + cboCodigoN.SelectedItem.ToString() + ", idIdioma= " + cboCodigoI.SelectedItem.ToString() + ", idFormato = " + cboCodigoF.SelectedItem.ToString() + ", fechaHoraProyeccion = " + Fecha.ToString() + ", estatus = " + Estatus.ToString() + " WHERE idProyeccionPelicula=" + lblC.Text.ToString()+"";
