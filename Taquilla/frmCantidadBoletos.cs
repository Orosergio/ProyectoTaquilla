...
namespace Taquilla
{
    public partial class frmCantidadBoletos : Form
    {
        ...
        {
            List<Boletos> infoBoletos = new List<Boletos>();
            if (Int32.Parse(lblCantidadTercera.Text)!=0)
            {
                infoBoletos.Add(new Boletos(idTipo1, Int32.Parse(lblCantidadTercera.Text)));
            }
            if (Int32.Parse(lblCantidadAdulto.Text) != 0)
            {
                infoBoletos.Add(new Boletos(idTipo2, Int32.Parse(lblCantidadAdulto.Text)));
            }
            if (Int32.Parse(lblCantidadNinos.Text) != 0)
            {
                infoBoletos.Add(new Boletos(idTipo3, Int32.Parse(lblCantidadNinos.Text)));
            }
