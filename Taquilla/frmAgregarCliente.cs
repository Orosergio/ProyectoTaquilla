                ...
                else
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            string insertarTarjeta = "INSERT INTO TARJETA (NOTARJETA,NITCLIENTE,ESTATUS) " +
                               "VALUES ("+int.Parse(lblTarjetaOriginada.Text.ToString())+",?,1)";
                        ...
                        {
                            //consulta para guardar la tarjeta del cliente
                            string insertarCorreo = "INSERT INTO CORREOCLIENTE (NITCLIENTE,CORREO,ESTATUS) " +
                               "VALUES (?,?,1)";
                            OdbcCommand comm3 = new OdbcCommand(insertarCorreo, cn.Conexion());
                            comm3.Parameters.Add("@NITCLIENTE", OdbcType.VarChar).Value = txtNit.Text.ToString();
                            comm3.Parameters.Add("@CORREO", OdbcType.VarChar).Value = txtCorreo.Text.ToString();
                            comm3.ExecuteNonQuery();
                        }
                        catch (Exception ex3)
                        {
